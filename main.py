...
def main(config):
    ...
    celeba_loader = get_loader(config.celeba_image_dir, config.attr_path, config.selected_attrs,
                               config.celeba_crop_size, config.image_size, config.batch_size, config.mode)
...
if __name__ == '__main__':
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, required=True)
    ...
    parser.add_argument('--fid_step', type=int, default=5000)
